...
var albums = require('../lib/models/albums.js');
var users_geek = [
  {
    "firstName": "Python",
    "lastName": "Do",
...
var find_singer_uri = encodeURI('/album/singer/郑钧');
var find_yaogun_uri = '/album/search?type=' + encodeURI('摇滚');
var find_minyao_uri = '/album/search?type=' + encodeURI('民谣');
...
describe('User', function() {
  ...
  it('/user/count/female should return 3', function(done) {
